...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const phone = '5219936237967';
      const text  = encodeURIComponent(
        `Hola Leones del Injudet 🥋\n\nSoy *${name}*.\nMe interesa: *${interest}*.\n\n${message}`
      );
  ...
  function drawFrameWithCursor() {
    ...
    if (glowX > 0) {
      ...
      cg.addColorStop(0,   'rgba(220,50,40,0.12)');
      cg.addColorStop(0.4, 'rgba(220,50,40,0.045)');
